...
public class CurrencyController {
	...
	public CurrencyController(CurrencyRepository repo, CurrencyBCClient currencyBCClient) {
		super();
		this.repo = repo;
	...
	public ResponseEntity <CurrencyEntity> getCurrency(
			...
			if(source.equals(target)) {
				...
				if(!source.equals("BRL")) {
					...
					if (resp.getValue().isEmpty()) throw new Exception("Currency not found " + source);
